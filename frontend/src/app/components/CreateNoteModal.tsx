...
export default function CreateNoteModal({
  ...
  return (
    <div 
      className="fixed inset-0 bg-[var(--github-bg)]/95 flex items-center justify-center z-50 p-4 backdrop-blur-md anim-fade-in transition-colors"
      onClick={onClose}
    >
      <div
      ...
      >
        ...
        <div className="p-6 space-y-6">
          <div>
            <input
              ...
              className="w-full text-2xl font-bold mb-1 bg-transparent outline-none border-b-2 border-default focus:border-[var(--github-accent)] pb-3 text-primary placeholder:text-secondary/60 transition-smooth"
              autoFocus
            />
          ...
          <div className="relative rounded-2xl bg-surface/40 border border-default/60 px-4 py-3 shadow-inner">
            <textarea
              ...
              className="w-full min-h-[280px] text-primary bg-transparent resize-none outline-none border-none focus:ring-0 leading-relaxed placeholder:text-secondary/60 text-base"
              style={{
        ...
        <div className="p-6 bg-surface/30 border-t border-default rounded-b-2xl flex justify-between items-center transition-colors">
