      ...
      <div className="card w-full max-w-md p-8 rounded-2xl shadow-2xl anim-scale-in relative z-10 backdrop-blur-sm">
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center mb-4">
            <img
              ...
              className="w-auto h-16 object-contain drop-shadow"
            />
          </div>
          <h1 className="text-3xl font-bold mb-2 text-primary tracking-tight">Create an Account</h1>
          <p className="text-sm text-secondary">Join CyberiaTech and start capturing your ideas</p>
        </div>
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          <div className="anim-slide-up" style={{ animationDelay: "40ms" }}>
            <label className="block text-xs font-semibold text-secondary mb-1.5 tracking-wide">PASSWORD</label>
            <input
              value={password}
          ...
          <div className="anim-slide-up" style={{ animationDelay: "80ms" }}>
            <label className="block text-xs font-semibold text-secondary mb-1.5 tracking-wide">CONFIRM PASSWORD</label>
            <input
        ...
        <div className="mt-6 text-center">
          ...
          >
            ...
            <span className="text-[var(--github-accent)] font-semibold group-hover:underline">Sign in</span>
